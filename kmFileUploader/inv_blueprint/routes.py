...
from kmFileUploader.inv_blueprint.utils import investigations_query_util, queryToDict, search_criteria_dictionary_util, \
...
import re
import logging
from kmFileUploader.inv_blueprint.utils_general import category_list_dict_util

logger = logging.getLogger(__name__)
logger.setLevel(logging.DEBUG)

file_handler = logging.FileHandler('kmFileUploader_inv_blueprint_log.txt')
